...
class AlrusafaEnrollScreen extends StatefulWidget {
  AlrusafaEnrollScreen({super.key});

  @override
  State<AlrusafaEnrollScreen> createState() => _AlkarkhEnrollScreenState();
}

class _AlkarkhEnrollScreenState extends State<AlrusafaEnrollScreen> {
