// ignore_for_file: prefer_const_constructors, prefer_const_literals_to_create_immutables, sized_box_for_whitespace, sort_child_properties_last, unused_local_variable

import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:flutter_application_1/admin/member_detail_screen.dart';
import 'package:pdf/pdf.dart';
import 'package:pdf/widgets.dart' as pw;
import 'package:printing/printing.dart';

class NestFamilyScreen extends StatefulWidget {
  final String categoryId;
  final String name;
  final String title;
  const NestFamilyScreen(
      {super.key,
  ...
  @override
  State<NestFamilyScreen> createState() => _MembersScreenState();
}

class _MembersScreenState extends State<NestFamilyScreen> {
