...
import 'package:flutter_application_1/widgets/custom_add_photo.dart';
...
class AddFamilyMemberScreen extends StatefulWidget {
  ...
  @override
  State<AddFamilyMemberScreen> createState() => _AlkarkhEnrollScreenState();
}

class _AlkarkhEnrollScreenState extends State<AddFamilyMemberScreen> {
            ...
            children: [
              ...
              InkWell(
                onTap: () async {
                  await candidateData
                      .add({
                        'familyId': routeArgument['familyId'],
                        'type': 'family',
                        'familyMode': 'no',
                        ...
                        'side': selectedItem2 == 'الاعظمية' ||
                                selectedItem2 == 'أبو غريب' ||
                                selectedItem2 == 'المنصور' ||
                                selectedItem2 == 'الدورة' ||
                                selectedItem2 == 'التاجي' ||
                                selectedItem2 == 'المحمودية'
                            ? 'alkarkh'
                            : 'alrusafa',
